...
<div
    x-data="{
        ...
        formAction: '',
        currentStatus: '',
        openModal(action, status, subject) {
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
    <form method="GET" action="{{ route('staff.service-requests.index') }}"
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                    ...
                    <td class="px-5 py-3.5 text-right whitespace-nowrap">
                        <button
                            @click="openModal(
                                '{{ route('staff.service-requests.update', $request) }}',
                                '{{ $request->status }}',
                                @js($request->subject)
                            )"
...
<div x-show="modalOpen" x-cloak
    ...
    <div class="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b dark:border-gray-700">
            <div>
                <h3 class="text-base font-semibold text-gray-900 dark:text-white">Update Request Status</h3>
