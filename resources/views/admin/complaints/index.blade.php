...
<div
    x-data="{
        ...
        currentAssignedTo: '',
        currentResolution: '',
        openModal(action, status, assignedTo, resolution, subject) {
            this.formAction        = action;
            this.currentStatus     = status;
            this.currentAssignedTo = assignedTo ?? '';
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead>
                <tr class="bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <th class="px-5 py-3.5 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Complainant</th>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr>
                    <td colspan="5" class="px-5 py-12 text-center">
                        ...
                        <p class="text-sm text-gray-400 dark:text-gray-500">No complaints found.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
...
<div x-show="modalOpen" x-cloak
    ...
    <div class="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b dark:border-gray-700">
            <div>
                <h3 class="text-base font-semibold text-gray-900 dark:text-white">Update Complaint</h3>
        ...
        <form method="POST" :action="formAction" class="px-6 py-5 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="assigned_to" x-model="currentAssignedTo"
            ...
            <div>
                ...
                <textarea name="resolution" x-model="currentResolution" rows="4"
